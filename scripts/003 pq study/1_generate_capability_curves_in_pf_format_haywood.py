...
RESULTS_FOLDER = r"""C:\Grid\Results\Heywood\results"""
os.makedirs(RESULTS_FOLDER, exist_ok=True)

INPUTS_FOLDER = r"""C:\Grid\heywoodbess\scripts\003 pq study"""
P_STEP_SIZE_MW = 0.01
...
def generate_inverter_pq_curve_in_pf_format() -> pd.DataFrame:
    curves_df = pd.read_csv(os.path.join(INPUTS_FOLDER, "PQ_raw.csv"))
...
def generate_visual_check_plots(df : pd.DataFrame):
    raw_curves_df = pd.read_csv(os.path.join(INPUTS_FOLDER, "PQ_raw.csv"))
