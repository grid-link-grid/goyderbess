...
MODEL_DIR = r"""C:\Grid\WorkFolder\Heywood work folder\WAN_TUNNING\Lowest_Case_2&4_retune\Model"""#r"""C:\Users\JaredGeere\Grid-Link\Projects - Documents\Enzen\CGBESS\02_Deliverables\029 WAN Cases\3_BK_Integration\Finalised cases\Case 2"""
...
XLSX_PATH_ENV = r"""C:\Users\AlvinBai\Grid-Link\Projects - Documents\Atmos\Heywood BESS R0\02_Deliverables\PROJECT_SPEC"""#r"""C:\Users\JaredGeere\Grid-Link\Projects - Documents\Enzen\CGBESS\02_Deliverables\028 R1 Package\05 WAN Spec"""#os.getenv("GESF_SPEC_PATH")
...
if RUN_STUDIES:
    ...
    RESULTS_DIR = os.path.join(r'''C:\Grid\Heywood work folder\WAN\results''',f"{SAV_VERSION}_sav_{DYR_VERSION}_dyr", now_str())
    
    if not os.path.exists(RESULTS_DIR):
        os.makedirs(RESULTS_DIR)

    spec = load_specs_from_xlsx(XLSX_PATH, sheet_names=SHEETS_TO_PROCESS, add_sheet_name_column=True)
    spec = spec[spec["Test No"]==41]
