...
class heywoodbessPscadPlotter(Plotter): 
    def __init__(
            self,
...
#------------------- ---------------------------------POC PLOTS -----------------------------------------------------------
        ...
        axes[0,0].plot(df.index, df["PRMTCMDOUT"], color=col_pallet[0], label='REF',linestyle="dashed",linewidth=1.5)
        ...
        min_val = min(df["PRMTCMDOUT"].min(),df["PLANT_P_HV"].min())
        max_val = max(df["PRMTCMDOUT"].max(),df["PLANT_P_HV"].max())
        ...
        axes[1,0].plot(df.index, df["VCMDOUT"], color=col_pallet[0], label='REF',linestyle="dashed",linewidth=1.5)
        ...
        min_val = min(df["VCMDOUT"].min(),df["PLANT_Q_HV"].min())
        max_val = max(df["VCMDOUT"].max(),df["PLANT_Q_HV"].max())
