...
def run_psse_studies(
        ...
        MODEL_DIR,
        RESULTS_DIR,
        skip_initialisation: Optional[bool],
        smib_study: Optional[bool]=True
  ):
    ...
    try:
        ...
        def post_init_callback():
            ...
            poc_voltage = p._case_definition.get_bus("CGBESS_POC").get_data(BusData.PU)
            poc_angle = p._case_definition.get_bus("CGBESS_POC").get_data(BusData.ANGLE)
