...
def calc_vslacks_with_caching(spec, use_cache : bool, spec_path, vbase_kv, fbase_hz):
    ...
    def use_cache_false(palletObject):
        ...
        vslack_cache = spec_for_vslack.filter(["Grid_FL_MVA_sig","Grid_X2R_sig","Vpoc_pu_sig","Ppoc_MW_sig","Qpoc_MVAr_sig","Vslack_pu_sig", "constant_vslack_pu_sig", "U_Ov", "TOV_MVAr", "TOV_Shunt_C_uF_sig"], axis=1)
    ...
    if use_cache == True:
        ...
        cols_to_match = ["Grid_FL_MVA_sig","Grid_X2R_sig","Vpoc_pu_sig","Ppoc_MW_sig_copy","Qpoc_MVAr_sig_copy", "U_Ov"]
        ...
        vslack_cache = pd.concat([vslack_cache, spec.filter(["Grid_FL_MVA_sig","Grid_X2R_sig","Vpoc_pu_sig","Ppoc_MW_sig_copy","Qpoc_MVAr_sig_copy",'constant_vslack_pu_sig', "U_Ov", "TOV_MVAr", "TOV_Shunt_C_uF_sig"])])
        vslack_cache['Ppoc_MW_sig'] = vslack_cache['Ppoc_MW_sig_copy']
        vslack_cache['Qpoc_MVAr_sig'] = vslack_cache['Qpoc_MVAr_sig_copy']
        vslack_cache['Vslack_pu_sig'] = vslack_cache['constant_vslack_pu_sig']
