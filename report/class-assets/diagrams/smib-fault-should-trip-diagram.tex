...
\resizebox{0.8\linewidth}{!}{ % Set width to \linewidth
	\begin{tikzpicture}[semithick]% default line width
		% Buses and branches
		\draw (0,0)
		node[red, left, font=\footnotesize]{Generator (should trip)} ++(1.5,0) \bushere{1.5}{Connection Point}{} coordinate(poc);
		\draw (poc)
		...
		\draw (poc) -- ++(-1,0) node[red, vsourcesinshape, rotate=90]{};
		% Fault
